...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, VendedorRegistradoEvent> vendedorRegistradoKafkaListenerContainerFactory() {
        return kafkaListenerContainerFactory(consumerFactory(VendedorRegistradoEvent.class));
    }
